package com.brin.denonremotefree.library.BlurNavigationDrawer.v7;
    ...
    public BlurDrawerLayout(Context context, AttributeSet attrs)
    {
        ...
        if (!isInEditMode())
        {
            ...
            try
            {
                ...
                float downScaleFactor = ta.getFloat(R.styleable.BlurDrawerLayout_downScaleFactor, BlurActionBarDrawerToggle.DEFAULT_DOWNSCALEFACTOR);

                int toolbarRef = ta.getResourceId(R.styleable.BlurDrawerLayout_toolbar, 0);
                Toolbar toolbar = (Toolbar) ((AppCompatActivity) getContext()).findViewById(toolbarRef);

                if (toolbar != null)
                    blurActionBarDrawerToggle = new BlurActionBarDrawerToggle((Activity) context, this, toolbar, openDescription, closeDescription);
                else
                    blurActionBarDrawerToggle = new BlurActionBarDrawerToggle((Activity) context, this, openDescription, closeDescription);
