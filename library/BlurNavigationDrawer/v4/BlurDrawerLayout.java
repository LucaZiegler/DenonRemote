package com.brin.denonremotefree.library.BlurNavigationDrawer.v4;
...
public class BlurDrawerLayout extends DrawerLayout
{
    ...
    public BlurDrawerLayout(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            blurActionBarDrawerToggle = new BlurActionBarDrawerToggle((Activity) context, this, drawerUpImage, openDescription, closeDescription);
